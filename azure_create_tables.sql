...
SELECT @sql += 'ALTER TABLE ' + QUOTENAME(t.TABLE_NAME) + ' DROP CONSTRAINT ' + QUOTENAME(c.CONSTRAINT_NAME) + ';'
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS c
JOIN INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS r ON c.CONSTRAINT_NAME = r.CONSTRAINT_NAME
JOIN INFORMATION_SCHEMA.TABLE_CONSTRAINTS t ON c.TABLE_NAME = t.TABLE_NAME
WHERE r.UNIQUE_CONSTRAINT_NAME = 'PK_User' AND c.CONSTRAINT_TYPE = 'FOREIGN KEY';
