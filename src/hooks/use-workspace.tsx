...
import { generateInitialUnassignedJobs, generateInitialOrders, generateInitialCustomers, generateInitialDocuments, generateInitialInventory, generateInitialRawMaterials, generateInitialPrinters, initialScheduleData, generateInitialCostingTemplates, generateInitialLoggedCalculations } from "./workspace-data";
...
export type WorkspaceContextType = Omit<WorkspaceData, 'idCounters'> & {
    printers: Printer[];
    enabledTabs: string[];
    isLoading: boolean;
...
// Create and export the workspace context
