...
export function PreviewTemplateModal({ isOpen, onClose, template }: PreviewTemplateModalProps) {
    ...
    const currencySymbol = currencySymbols[inputs.currency as keyof typeof currencySymbols];
                    ...
                    <div className="py-4 space-y-6 pr-4">
                        ...
                        {inputs.extraCosts.length > 0 && (
                            <>
                                ...
                                {inputs.extraCosts.map((cost: { name: string; baseAmount: number; percentage: number }, index: number) => (
                         ...
                         {inputs.packagingItems.length > 0 && inputs.packagingItems[0].name && (
                            <>
                                ...
                                {inputs.packagingItems.map((item: { name: string; quantity: number; unitPrice: number }, index: number) => (
