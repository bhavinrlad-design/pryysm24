...
import type { SavedCalculation } from '../../hooks/workspace';
                                ...
                                calculations.map(calc => {
                                    ...
                                    return (
                                        <TableRow key={calc.id} onDoubleClick={() => onLoad(calc.id)} className="cursor-pointer">
                                            ...
                                            <TableCell className="text-sm text-muted-foreground">{calc.createdAt ? format(new Date(calc.createdAt), "dd-MM-yy, h:mm a") : "N/A"}</TableCell>
