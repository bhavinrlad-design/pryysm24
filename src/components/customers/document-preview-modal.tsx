...
import type { Document, Customer } from '../../hooks/workspace'
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function DocumentPreviewModal({ isOpen, onClose, document, customer }: DocumentPreviewModalProps) {
    ...
    const handleDownloadPdf = () => {
        ...
        doc.setFontSize(20);
        doc.text(document.docType, 14, 22);
        ...
        autoTable(doc, {
            ...
            body: [
                [`${document.docType} for Order #${document.orderNumber}`, `${currencySymbol}${document.amount.toFixed(2)}`],
            ],
            foot: [
        ...
        doc.save(`${document.docType}-${document.orderNumber}.pdf`);
    };
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-2xl">
                <DialogHeader>
                    <DialogTitle>{document.docType} Preview</DialogTitle>
                    <DialogDescription>
                ...
                <div className="py-4 space-y-6 text-sm max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="flex justify-between items-start p-4 border rounded-lg">
                        <div>
                            <h3 className="font-semibold text-lg">{document.docType}</h3>
