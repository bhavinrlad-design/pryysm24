...
const formSchema = z.object({
  ...
  minStock: z.number().min(0, { message: "Min Stock can't be negative." }),
  minOrder: z.number().min(0, { message: "Min Order can't be negative." }),
                        ...
                        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                    <FormLabel>Minimum Order Level</FormLabel>
                                    <FormControl>
                                        <Input type="number" placeholder="0" {...field} />
                                    </FormControl>
                                    <FormMessage />
