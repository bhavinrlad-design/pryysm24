...
// Define a custom ScheduledJob interface that includes jobs array
                                ...
                                <Popover key={job.id}>
                                    <PopoverTrigger asChild>
                                        <button
                                            ...
                                            style={{ 
                                              left: `${left}px`, 
                                              width: `${width}px`, 
                                              backgroundColor: job.color || '#4f46e5' 
                                            }}
                                        >
                                    ...
                                    <PopoverContent className="w-60">
                                        <div className="space-y-2 text-sm">
                                            ...
                                            <p><strong>Duration:</strong> {job.duration !== undefined ? `${job.duration} hours` : 'N/A'}</p>
                                        </div>
                                    </PopoverContent>
                                </Popover>
                                )
