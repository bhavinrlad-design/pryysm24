...
import type { Printer, Job as WorkspaceJob, ItemGroup as WorkspaceItemGroup } from '../../hooks/workspace';
...
export interface MachineSchedule {
    printerId: string;
    jobs: (Job & { start: string; end: string })[];
}

export type ScheduledJob = MachineSchedule;
